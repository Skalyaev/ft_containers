...
void displayMap(name::map< myKeyType, myValueType > *a, name::map< myKeyType, myValueType > *b, name::map< myKeyType, myValueType > *c, name::map< myKeyType, myValueType > *d, name::map< myKeyType, myValueType > *e) {
        if (a) {
